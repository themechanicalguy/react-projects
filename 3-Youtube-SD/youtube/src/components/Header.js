  ...
  return (
    <div className="grid grid-flow-col p-5 m-2 shadow-lg">
      ...
      <div className="col-span-10 px-10">
        <div>
          <input
            className="w-1/2 border border-gray-400 p-2 rounder-l-full"
            type="text"
            value={searchQuery}
          ...
          />
          <button className="border border-gray-400 p-2 rounded-r-full p-2">
            🔍
          </button>
        </div>
        {showSuggestion && (
          <div className="fixed bg-white py-2 px-5 w-96 shadow-lg rounded-lg border border-gray-300">
            <ul>
              {searchSuggestion &&
